...
\begin{figure}[H]
    \centering
     \adjustbox{max w                                                                                                                   idth=2\textwidth, keepaspectratio}
     {\includegraphics{Total 改后.pdf}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{fig7_confidence_interval.pdf}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.5\textwidth]{fig4_did_effects.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{fig5_effect_distribution.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{fig2_countries_medals.pdf}
