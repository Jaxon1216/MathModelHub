...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{Total.drawio (1).pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{fig1_target_distribution.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{fig3_host_effect.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{fig4_feature_importance.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{fig5_model_comparison.pdf}
    \caption{Model Performance Comparison}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{fig6_2028_prediction.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig7_confidence_interval.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{fig5_effect_distribution.pdf}
...
Figure 17 (placeholder, fig1\_concentration\_trend.pdf): Evolution of medal concentration. This figure displays the time-series changes of the Gini coefficient and the medal share of Top 10 nations between 1896 and 2024 in a dual-axis line chart. Both curves show a long-term downward trend, indicating that medal distribution is shifting from high concentration toward relative equilibrium, and the global sports competition landscape is becoming increasingly diversified.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{fig1_concentration_trend.pdf}
    \caption{Evolution of medal concentration}
    \label{fig:concentration_trend}
\end{figure}

Figure 18 (placeholder, fig2\_countries\_medals.pdf): Changes in medal-winning nations and medals per capita. This figure consists of two subplots: the left plot shows the growth trend in the number of medal-winning nations across Olympic history, increasing from approximately 15 to about 90; the right plot shows the change in the average number of medals per winning nation. As the number of winning nations increases, the medals per capita tend to stabilize, reflecting an increase in competitive participation.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig2_countries_medals.pdf}
...
Figure 19 (placeholder, fig3\_rising\_stars.pdf): Trajectories of rising dark horse nations. This figure displays the medal count time-series for several typical dark horse nations (e.g., China, the UK, Japan, South Korea) using multiple lines. The figure illustrates the complete trajectory of these nations from low-level accumulation and accelerated growth to structural breakthroughs, validating the universality of the "20-year rise rule."

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{fig3_rising_stars.pdf}
...
Figure 20 (placeholder, fig4\_sport\_competition.pdf): Landscape of sports competition. This figure presents the competitive characteristics of various sports in a bubble scatter plot: the horizontal axis represents the number of medal-winning nations (higher values indicate greater participation), the vertical axis represents the Top 3 nations' share (higher values indicate stronger monopoly), and the bubble size indicates the total number of medals in that sport. Different quadrants in the figure identify project types, providing a visual basis for differentiated investment strategies.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{fig4_sport_competition.pdf}
    \caption{Landscape of sports competition}
    \label{fig:sport_competition}
\end{figure}

This figure categorizes various sports into four quadrants based on "competition intensity" and "opportunity for small nations." The upper-right quadrant contains "high opportunity, low competition" blue ocean projects suitable for priority layout by emerging nations; the lower-left quadrant contains "low opportunity, high competition" red ocean projects, which nations with limited resources are advised to enter cautiously.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{fig5_investment_matrix.pdf}
...
\begin{figure}[H]
    ...
    \caption{Bootstrap Robustness Map}
    \label{fig:fig26}
\end{figure}
