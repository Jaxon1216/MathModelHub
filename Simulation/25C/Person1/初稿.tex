...
\usepackage{array}
\usepackage{float}
\graphicspath{{Q2 figures/}{Q3figures/}}  % 表示从当前.tex文件所在目录，找同级的Q2 figures文件夹}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}\textit{flowchart\_q2\_method.svg}\\\texttt{figures/flowchart\_q2\_method.svg}\vspace{2cm}}}
