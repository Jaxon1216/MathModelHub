...
\graphicspath{{../../Coder/问题一/figures/}{../../Coder/问题二/figures/png/}{../../Coder/问题三/figures/png/}}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig1_target_distribution.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig3_host_effect.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig6_2028_prediction.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig8_poisson_distribution.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{flowchart_q2_method.svg.png}
    \caption{Method pipeline for identifying the Great Coach Effect.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig1_changepoint_distribution.svg.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig4_did_effects.svg.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig6_investment_recommendations.svg.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig1_concentration_trend.svg.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig3_rising_stars.svg.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig4_sport_competition.svg.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{fig7_country_types.svg.png}
