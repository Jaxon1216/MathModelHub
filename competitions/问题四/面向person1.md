...
### 3.3 整体争议选手DWVS影响（新增亮点）

使用量化定义（Controversy Score ≥ 3）识别出的**32名争议选手**的DWVS模拟结果：
...
| 选手 | 季数 | 原名次 | 争议度 | 变化 |
|------|------|--------|--------|------|
| Bobby Bones | 27 | 1st | 7 | +1.1 |
| Bill Engvall | 17 | 4th | 5 | +1.2 |
| Alek Skarlatos | 21 | 3rd | 5 | +1.2 |
| Iman Shumpert | 30 | 1st | 5 | +1.0 |
| Michael Waltrip | 19 | 7th | 5 | +0.6 |

**关键发现**：
- DWVS对**所有争议选手**都有调整效果，而非仅针对个例
- 争议度越高，调整幅度越大（正相关）
- 证明新系统提供**普遍性、比例性的公平修正**
