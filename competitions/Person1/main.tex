...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.62\textwidth]{Q1_fig6_controversial_group.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{SA_fig5_radar_comprehensive.pdf}
...
\textbf{From:} MCM Analysis Team \#2613942\\
\textbf{Subject:} Voting System Analysis and Recommendations \\
\textbf{Date:} February 3, 2026
% 在右上角插入图片，使用picture环境进行绝对定位
\begin{picture}(0,0)
\put(200,0){\includegraphics[width=0.3\textwidth]{icon.png}}
\end{picture}


\vspace{0.5em} % 压缩头部与正文的间距
...
\bibitem{diciccio1996} T. J. DiCiccio and B. Efron, ``Bootstrap confidence intervals,'' \textit{Statistical Science}, vol. 11, no. 3, pp. 189--228, 1996.
